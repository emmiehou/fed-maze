...
class FED3 {
    ...
    public:
	  ...
	  bool nowFeeding = false; //added for compatibility with centerPoke
	  ...
	  // custom rule shifting variables 
	  int counter = 0;    // counter for pellets within the loop
       int ruleshiftPhase = 0; // how many rule shifts 
        int soundRule;
	  int sideRule;
	  int lightRule;
	  int trialNum;
